...
class ConservationLegislationSeeder extends Seeder
{
    ...
    public function run()
    {
        ConservationLegislation::firstOrCreate(['slug' => 'serbia-2'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Заштићена (РС)', 'description' => 'Прилог 2 Правилника о проглашењу и заштити строго заштићених и заштићених дивљих врста биљака, животиња и гљива ("Службени гласник РС", бр 5/2010 и 47/2011)'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'serbia-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Строго заштићена (РС)', 'description' => 'Прилог 1 Правилника о проглашењу и заштити строго заштићених и заштићених дивљих врста биљака, животиња и гљива ("Службени гласник РС", бр 5/2010 и 47/2011)'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'habitat-2'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ДС, Анекс 2', 'description' => 'Директива о стаништима, Aнекс 2'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'habitat-4'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ДС, Анекс 4', 'description' => 'Директива о стаништима, Анекс 4'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'habitat-5'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ДС, Анекс 5', 'description' => 'Директива о стаништима, Анекс 5'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bern-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Берн, Aнекс 1', 'description' => 'Конвенција о очувању европске дивље флоре, фауне и природних станишта - Строго заштићене биљне врсте'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bern-2'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Берн, Aнекс 2', 'description' => 'Конвенција о очувању европске дивље флоре, фауне и природних станишта - Строго заштићене животињске врсте'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bern-3'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Берн, Aнекс 3', 'description' => 'Конвенција о очувању европске дивље флоре, фауне и природних станишта - Заштићене животињске врсте'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bern-resolution-6-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Берн резолуција 6', 'description' => 'Конвенција о очувању европске дивље флоре, фауне и природних станишта - Врсте које захтевају заштиту специфичних станишта'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'cites-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ЦИТЕС, Aнекс 1', 'description' => 'Конвенција о међународној трговини угроженим дивљим врстама биљака и животиња - Анекс 1, врсте које можда нису угрожене али то могу постати'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'cites-2'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ЦИТЕС, Aнекс 2', 'description' => 'Конвенција о међународној трговини угроженим дивљим врстама биљака и животиња - Анекс 2, врсте које су најугроженије'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'birds-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Директива о птицама, Анекс 1', 'description' => 'Директива 2009/147/EC Европског парламента и Савета Европе од 30. новембра 2009. о очувању дивљих птица - Анекс 1'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'birds-2a'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Директива о птицама, Анекс 2а', 'description' => 'Директива 2009/147/EC Европског парламента и Савета Европе од 30. новембра 2009. о очувању дивљих птица - Анекс 2a'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'birds-2b'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Директива о птицама, Анекс 2б', 'description' => 'Директива 2009/147/EC Европског парламента и Савета Европе од 30. новембра 2009. о очувању дивљих птица - Анекс 2б'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'birds-3a'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Директива о птицама, Анекс 3а', 'description' => 'Директива 2009/147/EC Европског парламента и Савета Европе од 30. новембра 2009. о очувању дивљих птица - Анекс 3a'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'birds-3b'])->update([
            ...
            'bs-Cyrl' => ['name' => 'Директива о птицама, Анекс 3б', 'description' => 'Директива 2009/147/EC Европског парламента и Савета Европе од 30. новембра 2009. о очувању дивљих птица - Анекс 3б'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bonn-1'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ЦМС, Анекс 1', 'description' => 'Конвенција о очувању миграторних врста дивљих животиња ili Бонска конвенција - Анекс 1'],
        ...
        ConservationLegislation::firstOrCreate(['slug' => 'bonn-2'])->update([
            ...
            'bs-Cyrl' => ['name' => 'ЦМС, Анекс 2', 'description' => 'Конвенција о очувању миграторних врста дивљих животиња ili Бонска конвенција - Анекс 2'],
