...
abstract class BaseExport
{
     ...
     * @return \App\Export
     */
    public static function create(array $columns, array $filter, bool $withHeader, string $filetype)
    {
     ...
     */
    private function makeWriter($path, $filetype)
    {
        if ($filetype == 'xlsx') {
    ...
    private function exportToTempFile(Export $export)
    {
        ...
        $writer = $this->makeWriter($tempFilePath, $export->filetype());
    ...
    {
        return WriterEntityFactory::createRowFromArray(array_map(function ($column) use ($data) {
